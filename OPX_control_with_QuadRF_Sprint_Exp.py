...
def  Sprint_Exp(m_off_time, m_time, m_window, shutter_open_time,
    ...
    align(*all_detectors,"PULSER_N", "PULSER_S", "AOM_2-2'")
    ...
    wait(292, *all_detectors)  # TODO: Dor ???
    ...
    with for_(n, 0, n < m_time * 4, n + m_window):
        measure("readout_SPRINT", "detector_with_dig_out", None, time_tagging.digital(tt_vec1, m_window,
                                                     element_output="out", targetLen=counts1))
...
def opx_control(obj, qm):
    with program() as opx_control_prog:
        ...
        with infinite_loop_():
            ...
            align(*all_elements,*all_detectors, "AOM_2-2/3'", "AOM_2-2'", "PULSER_N", "PULSER_S")
