...
all_elements = ["Cooling_Sequence", "MOT_AOM_0", "MOT_AOM_-", "MOT_AOM_+", "AntiHelmholtz_Coils", "Measurement","MW_Antenna"]
...
def MOT(mot_repetitions, OD_Attenuation):
    ...
    align("Cooling_Sequence", "MOT_AOM_0", "MOT_AOM_-", "MOT_AOM_+", "AntiHelmholtz_Coils", "Zeeman_Coils",
          "AOM_2-2/3'", "AOM_2-3'_for_interference", "FLR_detection", "Measurement", "MW_Antenna") # , "Dig_detectors_spectrum", "Dig_detectors") # , "PULSER_N", "PULSER_S")
    ...
    with for_(n, 1, n <= mot_repetitions, n + 1):
        ...
        # play("OD_FS" * amp(0), "AOM_2-2/3'") # seems to be needed to run od at mw function
        # play('pulse1', "MW_Antenna")
    ...
    align("Cooling_Sequence", "MOT_AOM_0", "MOT_AOM_-", "MOT_AOM_+", "AntiHelmholtz_Coils", "Zeeman_Coils",
          "AOM_2-2/3'", "FLR_detection", "Measurement") # , "Dig_detectors", "Dig_detectors_spectrum") #, "PULSER_N", "PULSER_S")
...
def MW_spectroscopy(MW_freq, pulse_length_MW, pulse_length_OD):
    ...
    :param delta_f:
    :param MW_freq:
    :param pulse_length_MW:
    :param pulse_length_OD:
    :return:
    """
    ...
    # wait for quadrf/depump to end
    wait(us(15),"AOM_2-2/3'")
    ...
    play("OD" * amp(0.4), "AOM_2-2/3'", duration=pulse_length_OD)
    align("MW_Antenna", "AOM_2-2/3'")

    # Start Antenna pulse
    play('pulse1', "MW_Antenna", duration=pulse_length_MW)
    align("MW_Antenna", "AOM_2-2/3'")
...
def opx_control(obj, qm):
    with program() as opx_control_prog:
        ...
        with infinite_loop_():
            ...
            align(*all_elements, "AOM_2-2/3'")  # , "Dig_detectors"
