...
import Experiments.MWSpectroscopy.MWSpectroscopy_Config_Experiment as Config


# These values will be added/override the ones in Initial_Values (e.g. Common Experiment Values)
Experiment_Values = {
    'Experiment_Name': 'MWSpectroscopy',
    ...
    # 'Fountain_final_Delta_freq': 0.31e6,  # 0.31e6 - until 17.03.24
    # 'Fountain_final_Delta_freq': 0.3e6,  # 0.315e6 - until 28.02.24
    'Fountain_final_Delta_freq': 0.34e6,  # 0.315e6 - until 28.02.24
