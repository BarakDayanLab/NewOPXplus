...
Gaussian_pulse_samples = Utils.gauss_adaptive(0.2, 1000)
...
# TODO: Can this section be removed - it is not used
    ...
    'controllers': {
        controller: {
            ...
            'analog_outputs': {
                ...
                6: {'offset': +0.0},  # AOM S
                # TODO: What exactly are these output channels used when running CoolingOptimization?
                # 7: {'offset': dc_i},  # MW_I  (???)
                # 8: {'offset': dc_q},  # MW_Q  (???)
                7: {'offset': +0.0},  # MW_I
                8: {'offset': +0.0},  # MW_Q
            ...
            'digital_outputs': {
                ...
                4: {},  # Magnetic Fountain TTL Switch ON/OFF
...
# Note: the CoolingOptimization process does not require any streams, so this is empty
streams = {
}