...
# For pulse sync
det_pulse_amp_Ancilla = [0.45, 0, 0, 0, 0, 0, 0, 0]
...
Pulses_Amp = 0.45
# For pulse sync
det_pulse_amp_Early = [1, 0, 0, 0, 0, 0, 0, 0]
...
QRAM_Exp_Square_samples_Early = QRAM_Exp_Square_samples(amp=Pulses_Amp,
...
# For pulse sync
det_pulse_amp_Late = [1, 0, 0, 0, 0, 0, 0, 0]
...
num_init_val_FS_North = 12  # For only det pulses sequence
